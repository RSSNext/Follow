      ...
      >
        <SettingContext.Provider value={defaultCtx}>
          ...
          >
            ...
            <div
              className="flex h-0 flex-1 rounded-xl bg-theme-modal-background-opaque"
              ref={elementRef}
            >
              ...
              <div className="relative flex h-full min-w-0 flex-1 flex-col rounded-tr-xl bg-theme-background pt-1">
