      ...
      <SettingBuilder
        settings={[
          ...
          defineSettingItem("outlineEndpoint", {
            ...
            description: (
              <>
                {t("integration.outline.endpoint.description")}{" "}
                <a
                  target="_blank"
                  className="underline"
                  rel="noreferrer noopener"
                  href="https://app.getoutline.com/api"
                >
          ...
          defineSettingItem("outlineToken", {
            ...
            description: (
              <>
                {t("integration.outline.token.description")}{" "}
                <a
                  target="_blank"
                  className="underline"
                  rel="noreferrer noopener"
                  href="https://app.getoutline.com/settings/tokens"
                >
                  app.getoutline.com/settings/tokens
                </a>
                .
              </>
            ),
